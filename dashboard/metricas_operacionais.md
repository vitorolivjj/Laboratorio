...
**Última atualização automática:** 2026-08-29 (script local / GitHub Actions)
...
<!-- AUTO-SNAPSHOT:START -->
> **Snapshot automático** · gerado em **2026-08-29 16:14 UTC** · script `scripts/update_dashboard_snapshot.py`  
