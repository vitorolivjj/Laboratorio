...
**Última atualização automática:** 2026-06-28 (script local / GitHub Actions)
...
<!-- AUTO-SNAPSHOT:START -->
> **Snapshot automático** · gerado em **2026-06-28 13:43 UTC** · script `scripts/update_dashboard_snapshot.py`  
