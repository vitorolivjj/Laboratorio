...
**Última atualização automática:** 2026-07-24 (script local / GitHub Actions)
...
<!-- AUTO-SNAPSHOT:START -->
> **Snapshot automático** · gerado em **2026-07-24 13:41 UTC** · script `scripts/update_dashboard_snapshot.py`  
