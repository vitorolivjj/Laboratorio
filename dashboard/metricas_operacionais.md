...
**Última atualização automática:** 2026-06-29 (script local / GitHub Actions)
...
<!-- AUTO-SNAPSHOT:START -->
> **Snapshot automático** · gerado em **2026-06-29 15:43 UTC** · script `scripts/update_dashboard_snapshot.py`  
