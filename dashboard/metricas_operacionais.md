...
**Última atualização automática:** 2026-07-18 (script local / GitHub Actions)
...
<!-- AUTO-SNAPSHOT:START -->
> **Snapshot automático** · gerado em **2026-07-18 13:12 UTC** · script `scripts/update_dashboard_snapshot.py`  
