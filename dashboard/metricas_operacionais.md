...
**Última atualização automática:** 2026-08-03 (script local / GitHub Actions)
...
<!-- AUTO-SNAPSHOT:START -->
> **Snapshot automático** · gerado em **2026-08-03 14:35 UTC** · script `scripts/update_dashboard_snapshot.py`  
