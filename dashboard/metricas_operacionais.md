...
**Última atualização automática:** 2026-07-26 (script local / GitHub Actions)
...
<!-- AUTO-SNAPSHOT:START -->
> **Snapshot automático** · gerado em **2026-07-26 13:18 UTC** · script `scripts/update_dashboard_snapshot.py`  
