...
**Última atualização automática:** 2026-07-28 (script local / GitHub Actions)
...
<!-- AUTO-SNAPSHOT:START -->
> **Snapshot automático** · gerado em **2026-07-28 14:03 UTC** · script `scripts/update_dashboard_snapshot.py`  
