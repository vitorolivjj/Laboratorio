...
**Última atualização automática:** 2026-07-06 (script local / GitHub Actions)
...
<!-- AUTO-SNAPSHOT:START -->
> **Snapshot automático** · gerado em **2026-07-06 15:29 UTC** · script `scripts/update_dashboard_snapshot.py`  
