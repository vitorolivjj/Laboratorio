...
**Última atualização automática:** 2026-07-29 (script local / GitHub Actions)
...
<!-- AUTO-SNAPSHOT:START -->
> **Snapshot automático** · gerado em **2026-07-29 14:06 UTC** · script `scripts/update_dashboard_snapshot.py`  
