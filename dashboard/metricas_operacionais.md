...
**Última atualização automática:** 2026-07-11 (script local / GitHub Actions)
...
<!-- AUTO-SNAPSHOT:START -->
> **Snapshot automático** · gerado em **2026-07-11 13:16 UTC** · script `scripts/update_dashboard_snapshot.py`  
